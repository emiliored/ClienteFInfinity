...
public class AprecioConectar {
    ...
    public static Like obtenerLikesRecurso(int idUsuario,int idRecurso) {
        ...
        return client.target(
                "http://" + IPSERVER + ":"+Conectar.PORTSERVER+"/ServidorFInfinity/servicios/aprecio/likes?idUsuario="+idUsuario+"&idRecurso="+idRecurso)
    ...
    public static boolean anadirAprecio(Aprecio a){
        ...
        StatusType respuesta=client.target(
             "http://"+IPSERVER+":"+Conectar.PORTSERVER+"/ServidorFInfinity/servicios/aprecio" )
    ...
    public static boolean borrarAprecio(int idUsuario,int idRecurso){
        ...
        Client client=ClientBuilder.newClient();
        StatusType respuesta=client.target(
             "http://"+IPSERVER+":"+Conectar.PORTSERVER+"/ServidorFInfinity/servicios/aprecio?idUsuario="+idUsuario+"&idRecurso="+idRecurso)
